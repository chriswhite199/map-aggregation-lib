...
public class IntWritableAccumulateOutputAggregatorTest {
    @Test
    ...
    public void testAggregatorAutoFlush() throws IOException,
        ...
        Assert.assertEquals(new Text("B"), outputs.get(1).getFirst());
        Assert.assertEquals(new IntWritable(1), outputs.get(1).getSecond());

        Assert.assertEquals(new Text("B"), outputs.get(2).getFirst());
        Assert.assertEquals(new IntWritable(2), outputs.get(2).getSecond());

        Assert.assertEquals(new Text("C"), outputs.get(3).getFirst());
        Assert.assertEquals(new IntWritable(1), outputs.get(3).getSecond());
    }
}
